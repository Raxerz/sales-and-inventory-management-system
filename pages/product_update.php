...
include('../dist/includes/dbcon.php');
	...
	mysqli_query($con,"update product set prod_name='$name',prod_price='$price',prod_cost_price=$cost_price, main_qty=$qty,
	...
	echo "<script>document.location='product.php?success=2'</script>";  
