...
include('../dist/includes/dbcon.php');
	...
	$daily_transact_exist = mysqli_query($con, "SELECT * FROM daily_transactions WHERE date='$date_added' and cust_id='$cid' LIMIT 1");
	...
	if ($num_rows > 0) {
	  ...
	  while ($row=mysqli_fetch_array($daily_transact_exist)) {
	  	...
	  	mysqli_query($con, "INSERT INTO daily_transactions (date, cust_id, daily_collected, branch_id) VALUES('$date_added', '$cid', '$collected',  $branch)") or die(mysqli_error($con));
