...
<html>
  ...
  <body class="hold-transition skin-<?php echo $_SESSION['skin'];?> layout-top-nav">
    <div class="wrapper">
      ...
      ?>
      <script type='text/javascript'>swal('Success!','Successfully updated user details!','success');</script>
    <?php 
  } else if($_REQUEST['error']==1){
    ?>
      <script type='text/javascript'>swal('Passwords do not match!','','error');</script>    
    <?php
  }
  ?>
      <!-- Full Width Column -->
...
function myFunction() {
    ...
    var ok = true;
    if (pass1 != pass2) {
        swal('Invalid!','Passwords do not match!','error');
