                ...
                <ul class="nav navbar-nav">
                  ...
                  <li class="dropdown notifications-menu">
                    ...
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                      ...
                      <?php 
                      $query=mysqli_query($con,"select COUNT(*) as count from product where main_qty<=reorder and branch_id='$branch'")or die(mysqli_error());
                			$row=mysqli_fetch_array($query);
                			echo $row['count'];
                			?>	
                      </span>
                    ...
                    <ul class="dropdown-menu">
                      ...
                      <li>
                        ...
                        <?php
                        $queryprod=mysqli_query($con,"select prod_name from product where main_qty<=reorder and branch_id='$branch'")or die(mysqli_error());
                        ...
                        <ul class="menu" style="height:auto !important;">
                         ...
                         <a href="sales.php">
                              <i class="glyphicon glyphicon-usd text-blue"></i>Sales
                                                  ...
                                                  <li><!-- start notification -->
                         <a href="collection_collected_report.php">
                              <i class="glyphicon glyphicon-usd text-blue"></i>Collection
                            </a>
                          </li><!-- end notification -->
<!-- 					    <li>
