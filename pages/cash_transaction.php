        ...
        <div class="container">
	      ...
	      <div class="col-md-9">
              <div class="box box-primary">
                ...
                <input type="hidden" class="form-control" name="new" value="1" required>   
						  </div><!-- /.form group -->
					</div>
					<div class=" col-md-2">
						<div class="form-group">
	  ...
	  <div class="modal-content" style="height:auto">
          ...
          <input type="hidden" class="form-control" name="new" value="1" required>  	
				...
				<div class="form-group">
					...
					<div class="col-lg-9">
					  <input type="number" class="form-control" id="qty2" name="qty3" min="1" value="<?php echo $row['qty'];?>" required>  
					</div>
						  ...
						  <div class="form-group">
							<label for="date">Total</label>
							   <input type="hidden" class="form-control" name="cid" value="<?php echo $cid;?>" required>  
								...
								value="<?php echo $grand;?>" tabindex="5" readonly>
