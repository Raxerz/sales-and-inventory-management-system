...
<?php
  if($date!=null && $cid!="all"){
	   $query=mysqli_query($con,"select * from sales natural join sales_details natural join product natural join customer where date(date_added)>='$start' and date(date_added)<='$end' and branch_id='$branch' and modeofpayment='cash' and cust_id='$cid'")or die(mysqli_error($con));
   } else if($date==null && $cid!="all") {
     $query=mysqli_query($con,"select * from sales natural join sales_details natural join product natural join customer where branch_id='$branch' and modeofpayment='cash' and cust_id='$cid'")or die(mysqli_error($con));   
   } else if($date!=null && $cid=="all"){
     ...
     $query=mysqli_query($con,"select * from sales natural join sales_details natural join product natural join customer where branch_id='$branch' and modeofpayment='cash'")or die(mysqli_error($con));       
   }
