...
<html>
  ...
  <body class="hold-transition skin-<?php echo $_SESSION['skin'];?> layout-top-nav">
      ...
      ?>
      <script type='text/javascript'>swal('Success!','Successfully updated supplier details!','success');</script>
    <?php } else if($_REQUEST['success']==2){
  ?>
        <script type='text/javascript'>swal('Success!','Successfully added supplier details!','success');</script>
<?php }
?>
    <div class="wrapper">
